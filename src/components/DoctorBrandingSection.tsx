      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="max-w-3xl space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#EEF3FB] border border-[#446CB5]/20 text-xs font-bold text-[#446CB5]">
            ...
            <span>{isEn ? 'Specialized Domain' : 'Özel Hizmet Alanı'}</span>
          </div>

          <h2 className="font-['Inter_Tight'] text-3xl sm:text-4xl font-extrabold text-[#222222] tracking-tight leading-tight">
            {isEn ? (
              <>Doctor Brand Management: <span className="text-[#446CB5]">Patients Buy the Doctor First</span></>
            ) : (
          ...
          <p className="text-base sm:text-lg text-[#595F69] leading-relaxed">
            {isEn
              ? 'Great ads get your clinic noticed. But clinical trust is built by the surgeon. Before booking flights, prospective foreign patients scrutinize the doctor’s credentials, clinical philosophy, patient reviews, and AI/Google digital authority.'
            ...
            <div className="rounded-3xl overflow-hidden border border-[#DDE2E8] shadow-lg bg-white group transition-all duration-300 hover:shadow-xl">
              <div className="relative">
                <img 
                  ...
                  alt={isEn ? "Doctor Brand Management & Global Authority" : "Doktor Marka Yönetimi Dijital Profil ve Güven Sistemi"}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#16202E]/80 via-transparent to-transparent flex items-end p-6">
                  <div className="text-white space-y-1">
                    <div className="flex items-center gap-2 text-xs font-semibold text-[#60A5FA]">
                      ...
                      <span>{isEn ? 'Personal Digital Identity & Authority' : 'Kişisel Dijital Kimlik & İtibar'}</span>
                    </div>
                    <p className="font-['Inter_Tight'] font-bold text-lg text-white">
                      {isEn ? 'We Transform Surgeon Expertise Into a World-Class Brand' : 'Doktorunuzun Uzmanlığını Güçlü Bir Markaya Dönüştürüyoruz'}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="space-y-4">
              <h3 className="font-['Inter_Tight'] text-xl font-bold text-[#222222]">
                {isEn ? 'Why Doctor Brand Management Is Essential' : 'Neden Doktor Marka Yönetimi Şart?'}
              </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl bg-white border border-[#DDE2E8] space-y-2 shadow-xs hover:border-[#446CB5]/40 transition-colors">
                  <div className="flex items-center gap-2 text-sm font-bold text-[#222222]">
                    ...
                    <span>{isEn ? 'High-Trust Profile' : 'Güven Odaklı Profil'}</span>
                  </div>
                  <p className="text-xs text-[#595F69] leading-relaxed">
                    {isEn
                      ? 'Structuring your Instagram and digital presence to remove patient skepticism and accelerate booking decisions.'
                ...
                <div className="p-4 rounded-2xl bg-white border border-[#DDE2E8] space-y-2 shadow-xs hover:border-[#446CB5]/40 transition-colors">
                  <div className="flex items-center gap-2 text-sm font-bold text-[#222222]">
                    ...
                    <span>{isEn ? 'SEO & GEO Authority' : 'SEO & GEO Görünürlüğü'}</span>
                  </div>
                  <p className="text-xs text-[#595F69] leading-relaxed">
                    {isEn
                      ? 'Amplifying medical expertise signals so Google, ChatGPT, and Gemini cite and recommend the surgeon.'
                ...
                <div className="p-4 rounded-2xl bg-white border border-[#DDE2E8] space-y-2 shadow-xs hover:border-[#446CB5]/40 transition-colors">
                  <div className="flex items-center gap-2 text-sm font-bold text-[#222222]">
                    ...
                    <span>{isEn ? 'Higher Ad Conversions' : 'Yüksek Reklam Dönüşümü'}</span>
                  </div>
                  <p className="text-xs text-[#595F69] leading-relaxed">
                    {isEn
                      ? 'Patients connect having already bought into the doctor, relieving coordinators of initial trust-building friction.'
                ...
                <div className="p-4 rounded-2xl bg-white border border-[#DDE2E8] space-y-2 shadow-xs hover:border-[#446CB5]/40 transition-colors">
                  <div className="flex items-center gap-2 text-sm font-bold text-[#222222]">
                    ...
                    <span>{isEn ? 'Patient Advocacy & Reviews' : 'Hasta Deneyimi & İtibar'}</span>
                  </div>
                  <p className="text-xs text-[#595F69] leading-relaxed">
                    {isEn
                      ? 'Positioning verified patient testimonials and transformation stories transparently and impactfully.'
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              ...
              >
                <span>{isEn ? 'Explore Doctor Brand Management' : 'Doktor Marka Yönetimi Detaylarını İnceleyin'}</span>
              ...
              >
                <span>{isEn ? 'Schedule Strategy Session' : 'Strateji Görüşmesi Alın'}</span>
              </button>
            </div>
